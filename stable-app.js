const DATA_PARTS = [
  "./data/stable-part-00.txt",
  "./data/stable-part-01.txt",
  "./data/stable-part-02.txt",
  "./data/stable-part-03.txt",
  "./data/stable-part-04.txt",
];
...
async function loadCompressedJson() {
  ...
  if (!("DecompressionStream" in window)) {
    throw new Error("当前浏览器不支持 gzip 解压，请改用最新版 Chrome、Edge 或 Safari。");
  }
